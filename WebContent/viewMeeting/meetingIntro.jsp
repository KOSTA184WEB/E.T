					...
					<div class="navbar-collapse collapse">
						<div class="menu">
							<ul class="nav nav-tabs navbar-right">
								...
								<li><a></a></li>
								<li><a></a></li>
								<li role="presentation"><a href="${pageContext.request.contextPath}/viewAboutUs/AboutUs.jsp" >About US</a></li>
								<li role="presentation"><a href="${pageContext.request.contextPath}/viewMeeting/meetingIntro.jsp" class="active">Meet</a></li>
		...
		<footer>
			<div class="footer">
				<div class="container">
					<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.2s">
						<h2>Multi</h2>
						<p>In a elit in lorem congue varius. Sed nec arcu. Etiam sit amet augue. Fusce fermen tum neque a rutrum varius odio pede ullamcorp-er tellus ut
							dignissim nisi risus non tortor. Aliquam mollis neque.</p>
			...
			<div class="sub-footer">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							&copy; 2015 <a target="_blank" href="http://bootstraptaste.com/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">bootstraptaste</a>.
							All Rights Reserved.
						</div>
						<!-- 
