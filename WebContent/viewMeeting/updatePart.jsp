...
<form name=updateForm method=post action="ET" onSubmit="return checkValid()">
    ...
    <tr>
        ...
        <td width="450" height="20" ><b><span style="font-size:9pt;">
		<textarea name="description" cols="50" rows="10">${dto.meetingId}</textarea></span></b></td>
    </tr>
    <tr>
        <td width="150" height="20" >
