...
<script type="text/javascript">
	$(function() {
		$("#placesList").on("click", ".item .info", function() {
			alert($(this).children("span").eq(2).text());
			$("#resName").val($(this).children("h5").eq(0).text())
			$("#resAddr").val($(this).children("span").eq(0).text());
			$("#resPhone").val($(this).children("span").eq(2).text());
