...
<table cellspacing="0">
	...
	<tr>
		<th>전화번호</th>
		<td style="text-align:left">
		<input type="text" size="3" name="phone1" id="phone1" value="${memberPhone}" readonly="readonly"> -
		<input type="text" size="6" name="phone2" id="phone2" value="${memberPhone}" readonly="readonly"> -
		<input type="text" size="6" name="phone3" id="phone3" value="${memberPhone}" readonly="readonly">
		</td>
	</tr>
	<tr>
		<th>이메일 주소</th>
		<td style="text-align:left">
		<input type="text" size="15" name="email" id="email" value="${memberEmail}" readonly="readonly">
		</td>
	</tr>
	<tr>
		<th>아이디 찾기 질문</th>
		<td style="text-align:left"> ${memberQuestion} <br>
		<input type="text" size="30" name="answer" id="answer" value="${memberAnswer}" readonly="readonly"></td>
	</tr>
	...
	<tr>
		<td colspan="5" align="center"> 
			...
			<input type="button" value="탈퇴하기" id="leave"/>
		</td>
	</tr>
</table>
</form>	
