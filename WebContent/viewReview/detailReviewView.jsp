...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    ...
    <tr>
        ...
        <td width="300" height="20">
        	<span style="font-size:9pt;"><b>${requestScope.reviewDto.reviewWriteday}</b></span>
        </td>
        <td width="100" height="20" >
			<p align="right"><b><span style="font-size:9pt;">조회수</span></b></p>
		</td>
        <td width="100" height="20">
			<p><b><span style="font-size:9pt;"></span>${requestScope.reviewDto.reviewReadnum}</b></p>
		</td>
    </tr>
    <tr>
        <td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">모임일</span></b></p>
        </td>
        <td width="300" height="20">
        	<span style="font-size:9pt;"><b>${requestScope.meetingDate}</b></span>
        </td>
         <td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">작성자</span></b></p>
        </td>
        <td width="100" height="20">
        	<span style="font-size:9pt;"><b>${reviewDto.memberId}</b></span>
        </td>
    </tr>
	<tr>
		<td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">참여한 모집하기 제목</span></b></p>
        </td>
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${requestScope.meetingTitle}</b></span>
        </td>
	</tr>
    <tr>
        <td width="100" height="20" >
            <p align="right"><b><span style="font-size:9pt;">음식점 종류</span></b></p>
        </td>
        <td width="300" height="20">
        	<span style="font-size:9pt;"><b>${requestScope.resKind}</b></span>
        </td>
        <td width="100" height="20" >
			<p align="right"><b><span style="font-size:9pt;">음식점 평점</span></b></p>
		</td>
        <td width="100" height="20">
			<p><b><span style="font-size:9pt;"></span>${requestScope.resRate}</b></p>
		</td>
    </tr>
    <tr>
        <td width="100" height="20">
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${requestScope.reviewDto.reviewTitle}</b></span>
        </td>
    </tr>
    <tr>
        ...
        <span style="font-size:9pt;"><b><pre>${requestScope.reviewDto.reviewContents}</pre></b></span></td>
    </tr>
