...
<form name=updateFormReview method=post action="${path}/ET" onSubmit="return checkValid()">
    ...
    <tr>
        ...
        <td width="450" height="20"><b><font color="black"><span style="font-size:9pt;"><input type=password name="reviewPw" size="12"> 
...
<hr>
<div align=right><span style="font-size:9pt;">&lt;<a href="${path}/ET?command=listReview">후기리스트</a>&gt;</span></div>
