...
<body>
   ...
   <iframe src="${pageContext.request.contextPath}/ET?command=boardMain" width="100%" height="850px" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
   </div> 
